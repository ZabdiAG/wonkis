...
public class listadeasistencia extends Activity {
 ...
 String get_grupos;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listadeasistencia);
        ...
        list.add("grupo1");
        list.add("grupo2");
        final List<String> dia = new ArrayList<String>();
        dia.add("10/04/2015");
        dia.add("11/04/2015");

        Spinner mySpinner = (Spinner) findViewById(R.id.my_spinner);
        mySpinner.setAdapter(new ArrayAdapter<String>(listadeasistencia.this,
        ...
        Spinner dia_spinner = (Spinner) findViewById(R.id.dia_spinner);
        dia_spinner.setAdapter(new ArrayAdapter<String>(listadeasistencia.this,
                android.R.layout.simple_spinner_dropdown_item,
                dia));
