...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nom_estudiante'])) {
        
        
        // Create some data that will be the JSON response 
        $response["success"] = 0;
        $response["message"] = "Ingresa los datos correctos porfavor!";
    ...
    $query        = " SELECT 1 FROM estudiantes WHERE nombre = :nom_estudiante";
    ...
    if ($row) {
        ...
        $response["success"] = 0;
        $response["message"] = "No puedes repetir nombres de alumnos";
        die(json_encode($response));
    }
    ...
    $query = "INSERT INTO estudiantes ( nombre, matricula ) VALUES ( :nom_estudiante, :matricula ) ";
...
?>
	...
	<form action="nuevogrupo.php" method="post"> 
	    ...
	    <input type="submit" value="Register grupo" /> 
	</form>
	<?php
}
